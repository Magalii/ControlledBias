...
class StudentMaleDataset(StandardDataset):
    ...
    def __init__(self, df = None, balanced=False, label_name='G3',
        ...
        """
            balanced : whether the original dataset is kept (False) or is balanced according to sensitive attribute and outcome by randomdly removing some female student with positive outcome
    ...
    def to_df_multiclass(self,label_multi: str) :
        # Return the dataset content as a Dataframe with the additional feature 'label multiclass' holding a numerical label corresponding to the grade G3
